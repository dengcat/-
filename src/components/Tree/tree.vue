<template>
  ...
  <div
          style="border: 1px solid #ebeef5;background-color: #fafafa;height:38px; border-bottom-width:2px;display:inline-block;width:300px"
        >
          <div
    ...
    padding-left: 10px;"
          >组织</div></div>
          <div
          style="border: 1px solid #ebeef5;background-color: #fafafa;height:38px; border-bottom-width:2px;display:inline-block;width:200px"
        ><div
            style="position: relative;
    overflow-wrap: normal;
    text-overflow: ellipsis;
